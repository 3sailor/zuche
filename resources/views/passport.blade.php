...
<div class="zc-pbox">
	<div class="zc-inbox">
		<div class="reg-l">
			...
			<a class="zc-btn btn-reg" href="" id="nextButton" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','注册页-注册按钮')"><input class="zc-btn btn-reg" type="submit" value="注册"></a>
		</form>
		</div>
		<div class="reg-r">
			<p class="reg-title rtitle">已有账号？<a href="{{ URL('/login') }}" rel="nofollow" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','注册页立即登录')">立即登录&nbsp;»</a></p>
