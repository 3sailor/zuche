...
<html lang="en">
	...
	<body class="login-layout">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">神州</span>
									<span class="white">租车</span>
								</h1>
												...
												<fieldset>
													...
													<div class="clearfix">
														<label class="col-xs-6">
															<span class="block input-icon input-icon-right">
																<input type="password" class="form-control col-xm-6" placeholder="验证码" name="code" />
														...
														<div class="col-xs-6">
														<!-- 验证码图片 -->
															<img src="{{ URL('admin/captcha/time()') }}">
														</div>
													</div>
		...
		<script src="{{ asset('admins/assets/js/jquery-2.0.3.min.js') }}"></script>
...
<![endif]-->
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='{{ asset('admins/assets/js/jquery-2.0.3.min.js')}}'>"+"<"+"/script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='{{ asset('admins/assets/js/jquery-1.10.2.min.js') }}'>"+"<"+"/script>");
</script>
<![endif]-->

		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='{{ asset('admins/assets/js/jquery.mobile.custom.min.js') }}'>"+"<"+"/script>");
		</script>
