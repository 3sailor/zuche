...
<html>
<head>
    <link href="{{ asset('css/style1.css') }}" type="text/css" rel="stylesheet">
    ...
    <title>神州租车—中国最大租车公司!天天超低价!!!</title>   
    <link href="css/index.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/cityport_yellow.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/daty.css') }} ">
...
<style type="text/css">.amap-container{cursor:url(http://webapi.amap.com/theme/v1.3/openhand.cur),default;}.amap-drag{cursor:url(http://webapi.amap.com/theme/v1.3/closedhand.cur),default;}</style><script src="{{ asset('js/logger.js') }}"></script>
    <link type="text/css" rel="stylesheet" href="{{ asset('css/bdsstyle.css') }}">
</head>
<body class="zc_index">
<!--head start -->
<script type="text/javascript">
...
<script type="text/javascript" src="{{ asset('js/seaconfig.js') }}"></script>
<link href="{{ asset('css/zc_global.css') }}" rel="stylesheet" type="text/css">
    ...
    <div class="zc_main">
        ...
        <div class="zcindex_login">
            @if(session('user'))
                ...
                <div class="zc_index_my">
                    <a href="{{ asset('/myzuche/duanzu') }}" class="top">我的神州<i class="zc_ordown"></i></a>
                    <div class="contmyszlist">
                    <div class="p-re">
                            <span class="y">◆</span>
                            <a href="{{ asset('/myzuche/duanzu') }}" class="bhpr reddot" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','我的神州-我的订单')">我的订单
                            </a>
                            <a href="/myzuche">我的资产</a>
                            <a href="/myzuche">我的账户</a>
                            <a href="/logout" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','我的神州-退出登陆')">退出登录</a>
                    </div>
                    </div>
                </div>
                <div class="clear"></div>
            ...
            <div style="display: block;" class="wdl" id="notLogin">
                <a href="{{ URL('login') }}" class="colfabe00" id="loginBT" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-登录（顶）')">登录</a>
                <b>/</b>
                <a href="{{ URL('/passport') }}" class="colfabe00" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-注册（顶）')">注册</a>

                <a href="{{ URL('/login') }}" class="colc8c8ce ml20" onclick="dcsMultiTrack('DCS.dcsuri', '/zuchepc.event','WT.mc_click','首页-我的神州（顶）')">我的神州</a>
            </div>
        ...
        <div class="zc_phone_bd">
            <div class="p-re zc_p_h">
                ...
                <div class="zc_ga_phonebox"><img src="{{ asset('img/zc_gaphone.png') }}" alt="港澳台及海外电话861058209555">
                </div>
            </div>
