 ...
 <script type="text/javascript">
    ...
    <div class="zc_myright fr">
        <div class="zc_ipttitle_bd zc_coltdinfo" >
            <h2>我的信息</h2>
            <div id="originalDiv">
                <form action="{{ URL('/myzuche/xinxi') }}" method='post'>
                ...
                <ul>
                    <li>
                        ...
                        <input class="zc-ipt" type="text" id='memberNameInput'  maxlength="30"
                            value="{{ $vo->user }}" />
                        </span>
                    ...
                    <li class="cards_info">
                        ...
                        <span class="fl cards_show">
                            <span>
                            身份证/驾驶证：{{ $vo->user }}</span>
                        </span>
                        <div class="fr">如需修改，请致电400-616-6666</div>
                        <div class="clear"></div>
                    </li>
                    <li>
                        <label class="fl">手机号码</label>
                        <span class="fl fc_c6" id="xmobile">{{ $vo->user }}</span>
                    ...
                    <li>
                        ...
                        <span class="fl">
                            <input class="zc-ipt" type="text" id="xemail" value="{{ $vo->user }}" maxlength="50"/>
                            <input type="hidden" id="originEmail" value='{{ $vo->user }}' />
                        </span>
        ...
        <div class="zc_mysucceed_bd" id="modifySuccess" style="display:none">
            ...
            <p class="ac"><a class="zc_orange_bigsub" href="http://mycar.zuche.com/member/person/personinfo.do">返回</a></p>
        </div>
      </div>
   </div>
