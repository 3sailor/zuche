 ...
 <script type="text/javascript">
    ...
    <div class="zc_myright fr">
        <div class="zc_myassets_bd">
            <div class="h2">
                <div class="fl">
                    <span class="title">我的可用积分</span>
                    <span class="titletwo"><em class="orff8650">0分</em></span>
                    </div>
                <div class="fr">   
                    <span class="menu_regulation">
                        <a class="clickpdf" href="http://help.zuche.com/jsp/newhelp/fwgz.jsp#fwgz15" target="_blank">查看积分说明及用途</a>
                    </span>
                </div>
            ...
            <div class="p-re my_kyjfinfo">
                ...
                <div class="zc_query-condition_bd" style="top:11px;">
                    <div class="zc_box" style="padding-right:10px;">
                        ...
                        <div class="fr pl15"><input id="searchBtn" type="button" value="查询" class="zc_gray_sub"></div>
                        <div class="fr"><input type="text" value="" 
                            class="w175 zc_iptcalendar"  id="toDate" autocomplete="on" readonly="readonly"></div>
                        <div class="fr">-</div>
                        <div class="fr"><input type="text" value=""
                            class="w175 zc_iptcalendar"  id="fromDate" autocomplete="on" readonly="readonly"></div>
                        <div class="clear"></div>
                    </div>
                </div>
            </div>
            <div class="zc_notinfo_bd">
                        <img src="http://image.zuchecdn.com/newversion/news/common/grayintegral.png" width="120" height="120">
                        <p>会员积分不能再低啦，多多租车就能翻身！</p>
                        <a href="http://order.zuche.com" target="_blank" class="zc_orange_sub">立即租车</a>
                    </div>
                <div><a href="http://mycar.zuche.com/scoreshop/getGoodsList.do"><img src="http://image.zuchecdn.com/newversion/news/common/conversionzczcq.jpg" width="860" height="90"></a></div>
            <div class="h20"></div>
        </div>
    </div>
    <div class="clear"></div>
