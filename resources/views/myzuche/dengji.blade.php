    ...
    <div class="zc_myright fr">
        <div class="zc_myassets_bd" name="mdszb" id="mdszb">
            <div class="h2">
                ...
                <span class="titlef12">会员成长体系包含5个会员等级，会员等级由“<sapn class="orff8650">累计积分</sapn>”决定，累计积分越高，会员等级越高。<a href="http://mycar.zuche.com/queryPoint/queryAllPoint.do?flag=curIntegral">查看累计积分记录</a></span>
                <div class="clear"></div>
            </div>
            <div class="h20"></div>
            <div>
                ...
                <ul class="tabsubbox">
                    <li class="cur" onclick="window.location.href='http://mycar.zuche.com/member/getMemberLevel.do'">我的等级</li>
                    <li onclick="window.location.href='http://mycar.zuche.com/queryPoint/queryAllPoint.do?flag=curIntegral'">累计积分记录</li>
                </ul>
                <div class="tabsubContents cur">
                    <div class="hierarchy-show">
                        <div class="cardbox">
                            <span class="ordinary_card"><i class="tel"></i></span></div>
