...
@include('myzuche')
 <script type="text/javascript">
    ...
    <div class="zc_myassets_bd" >
        <div class="h2">
          <div class="fl">
              <span class="title">我的储值卡</span>
              <span class="titletwo">卡号</span>
              <span>
                  <select class="w170selectipt" id="cardno_select">
                      <option>暂无可用储值卡</option>
              </select>
              </span>
          </div>
            <span class="menu_regulation pl15">
                <a class="clickpdf" id="menu_czk">储值卡规则</a>
                <div class="menu-regulation-bd" id="menu_czk_bd" style="left:-526px;">
                    <div class="p-re">
                        <span class="arrowbox" style="left:539px;">◆<span class="arrow">◆</span></span>
                        <a href="javascript:void(0);" class="close"></a>
                        <div class="f12">
                            1、储值卡支持预付、租金结算、租车押金支付（仅限预授权5000元以下的车型）和违章押金支付；<br>
                            2、使用储值卡消费不返积分；<br>
                            3、储值卡不计息、不兑现、不透支、不可充值，有效期三年，过期余额不退；<br>
                            4、您可在神州租车任一门店购买储值卡，购买时一次性开具发票，购卡后恕不能退；<br>
                            5、储值卡首次使用前，请由门店进行激活，激活时客户需输入密码；<br>
                            6、储值卡不允许转借；<br>
                            7、修改密码或挂失，请您致电400 616 6666时热线。
                        </div>
                    </div>
                </div>
            </span>
        ...
        <div class="v-c-bd">
                <span class="f14">余额: </span><em class="f18 orff8650" id="giftcardValue">￥0元</em>
                <div class="zc_query-condition_bd">
                    <form action="" method="post" name="queryForm" id="queryForm">
                    <div class="zc_box">
                        <div class="fr pl15"><input type="button" value="查询" class="zc_gray_sub" id="accountSearch"></div>
                        <div class="fr"><input type="text" name="endTempTime" id="endTempTime" readonly="readonly" value="2016-10-14" class="w175 zc_iptcalendar iptDate" autocomplete="on"></div>
                        <div class="fr w23">-</div>
                        <div class="fr"><input type="text"  class="w175 zc_iptcalendar iptDate"  name="startTempTime" id="startTempTime" readonly="readonly" value="2011-11-01" autocomplete="on"></div>
                        <div class="clear"></div>
                    </div>
                    </form>
                </div>
        ...
        <div>
              <div class="zc_notinfo_bd">
                  <img src="http://image.zuchecdn.com/newversion/news/common/grayka.png" width="120" height="120">
                  <p>木有储值记录，快快丰富起来~</p>
              </div>
          </div>
        </div>
