    ...
    <div class="zc_myright fr">
        <div class="zc_myassets_bd" >
                   <div class="h2">
                       ...
                       <span class="titletwo">可用 <em class="orff8650">1张</em></span>
                       <!-- 
                       <span class="menu_regulation pl15">
                           <a class="clickpdf" id="menu_yhq">使用说明</a>
                           <div class="menu-regulation-bd" id="menu_yhq_bd">
                               <div class="p-re">
                                   <span class="arrowbox">◆<span class="arrow">◆</span></span>
                                   <a href="javascript:void(0);" class="close"></a>
                                   <div class="f12">
                                       1、优惠券适用于全国所有直营门店（除海口、三亚、西双版纳、大理外）；<br>
                                       2、优惠券只能抵扣短租自驾的车辆租赁费，其它费用正常收取，每单限用1张；<br>
                                       3、优惠券不可折现，不可转让；<br>
                                       4、优惠券不适用于顺风车、周租、月租套餐产品；<br>
                                       5、优惠券不适用于赫兹旗下产品。
                                   </div>
                               </div>
                           </div>
                           ...
                           <ul style="width:882px;">
                               <li 
                                    ...
                                    >
                                       ...
                                       >
                                           <i class="zc_time_icon"></i>&#12288;有效期 : 2016.09.23-2017.03.22<div class="gbyhqexplain">
                                                   <div class="p-re">
                                       ...
                                       <div class="i-e-info">
                                               <div class="p-re">
                                                   <div class="h3">详细说明 </div>
                                                    <a href="javascript:void(0);" class="close"></a>
                                                   <div class="f12">
                                                       <b>新用户专享券</b><b>使用时间</b>2016年4月1日-2017年6月30日期间注册的客户,注册日起6个月内首次租车并还车结算有效;<b>使用规则</b>1.实际租期2天及以上的订单可用;<br>2.不与顺风车、预付特价、其他优惠活动、优惠类电子券同享;<br>3.此优惠仅限每人享受1次;<b>使用范围</b>全国各城市直营门店、不限制车型;</div>
                                               </div>
                                           </div>
                                       </li>
                               </ul>
